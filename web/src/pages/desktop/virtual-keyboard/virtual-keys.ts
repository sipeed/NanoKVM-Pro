...
export const keyboardOptions = {
  ...
  layout: {
    ...
    rus: [
      '{escape} F1 F2 F3 F4 F5 F6 F7 F8 F9 F10 F11 F12',
      'Backquote_rus Digit1_rus Digit2_rus Digit3_rus Digit4_rus Digit5_rus Digit6_rus Digit7_rus Digit8_rus Digit9_rus Digit0_rus Minus_rus Equal_rus {backspace}',
      '{tab} KeyQ_rus KeyW_rus KeyE_rus KeyR_rus KeyT_rus KeyY_rus KeyU_rus KeyI_rus KeyO_rus KeyP_rus BracketLeft_rus BracketRight_rus Backslash_rus',
      '{capslock} KeyA_rus KeyS_rus KeyD_rus KeyF_rus KeyG_rus KeyH_rus KeyJ_rus KeyK_rus KeyL_rus Semicolon_rus Quote_rus {enter}',
      '{shiftleft} KeyZ_rus KeyX_rus KeyC_rus KeyV_rus KeyB_rus KeyN_rus KeyM_rus Comma_rus Period_rus Slash_rus {shiftright}',
      '{controlleft} {winleft} {altleft} {space} {altright} {winright} {menu} {controlright}'
    ],
    azerty: [
      '{escape} F1 F2 F3 F4 F5 F6 F7 F8 F9 F10 F11 F12',
