...
func NewClient(ws *websocket.Conn, videoConn, audioConn *webrtc.PeerConnection) *Client {
	return &Client{
		ws:    ws,
		video: videoConn,
		audio: audioConn,
...
func (c *Client) AddTrack() (*Track, error) {
	// video track
	...
	audioSender, err := c.audio.AddTrack(audioTrack)
	if err != nil {
